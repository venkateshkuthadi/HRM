			...
			<center>
				...
				<form action="RegistrationServlet" method="post">
					...
					<div align="right">
						<div>
							<iframe
								src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d60882.118209439985!2d78.33450217972735!3d17.50119263872531!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb93de421c1c8b%3A0xd519ed11be128485!2sDhatri+Info+Solutions!5e0!3m2!1sen!2sin!4v1542008556997"
							...
							<table>
								<tr>
									...
									<td><input type=text onkeypress="clearForm()"
										id="firstName" name="firstName"><br> <br></td>
								...
								<tr>
									...
									<td><input type="text" onkeypress="clearForm()"
										id="lastName" name="lastName"><br> <br></td>
								...
								<tr>
									...
									<td><input type="text" onkeypress="clearForm()"
										id="fatherName" name="fatherName"><br> <br></td>
								...
								<tr>
									...
									<td><input type=text onkeypress="clearForm()"
										...
										placeholder="Mobile number" required><br> <br></td>
								...
								<tr>
									...
									<input type="reset" onclick="return registrationValidation()"
								...
								<table>
									<tr>
										...
										<td><input type=text name="schoolName"
											onkeypress="clearForm()" id="schoolName"><br> <br></td>
										...
										<td><input type=text name="tenthPassedOut"
											onkeypress="clearForm()" id="tenthPassedOut"></td>
									...
									<tr>
										...
										<td><input type=text name="interPassedOut"
											onkeypress="clearForm()" id="interPassedOut"></td>
										<td><p id="errorMsg13" style="color: red;"></p></td>

									</tr>
									<tr>
										<td>Graduation Details:<font color="red">*</font></td>
										<td><select name="graduationDetails"
											onkeypress="clearForm()" id="graduationDetails">
										...
										<td><input type=text name="graduationPassedOut"
											onkeypress="clearForm()" id="graduationPassedOut"></td>
									...
									<tr>
										...
										<td><input type=text name="university"
											onkeypress="clearForm()" id="university"></td>
								...
								<table>
									...
									<tr>
										...
										<td><input type=text name="companyName"
											onkeypress="clearForm()" id="companyName"><br> <br></td>
									...
									<tr>
										...
										<td><input type=text name="location"
											onkeypress="clearForm()" id="location"><br> <br></td>
									...
									<tr>
										...
										<td><input type=text name="experience"
											onkeypress="clearForm()" id="experience"><br> <br></td>
									...
									<tr>
										...
										<td><input type=text name="currentCTC"
											onkeypress="clearForm()" id="currentCTC"><br> <br></td>
									...
									<tr>
										...
										<td><input type=text name="expectedCTC"
											onkeypress="clearForm()" id="expectedCTC"><br> <br></td>
